...
SauceDemo é um site próprio de teste que representa um e-commerce, ele serve para ajudar os QAs -- principalmente iniciantes como eu -- a .... Sendo o usuário real esses QAs, e o usuário fictício pessoas que querem comprar na internet.
  
**2. Funcionalidades mapeadas — a lista completa que você levantou explorando o site.**  
Login, acessar o menu, mudar filtro, adicionar e remover produtos do carrinho, colocar os dados para compra e checar os dados e finalizar compra.  
